...
export class RabbitConnection {
    ...
    static async create(connectionURL = 'amqp://localhost'): Promise<RabbitConnection> {
    ...
    async assertExchange(exchange: string, topic: string, options: amqp.Options.AssertExchange): Promise<void> {
